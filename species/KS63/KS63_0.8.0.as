if(_root.KS63Installed != true)
{
   ...
   _root.traceOutput = function(a)
   {
      ...
      {
         _root.KoopaShell.output.text = _root.KoopaShell.output.text + "\n" + a;
         _root.KoopaShell.output.scroll = _root.KoopaShell.output.scroll + a.length;
      }
      else
      {
         trace(a);
